...
namespace WorkingWithEFCore
{
    ...
    {
        public static (int affected, int productId) AddProduct(int categoryId, string productName, decimal? price, short? stock)
        {
        ...
        public static (int affected, int productId) IncreaseProductPrice(
        ...
        {
            using NorthwindDb db = new();
            IQueryable<Product>? products = db.Products?.AsQueryable().Where(
        ...
        public static (int affected, int[]? productIds)
            IncreaseProductPricesBetter(string productNameStartsWith, decimal amount)
        {
            using NorthwindDb db = new();
        ...
        public static int DeleteProductsBetter(string productNameStartsWith)
        {
            using NorthwindDb db = new();
            int affected = 0;
            IQueryable<Product>? products = db.Products?.Where(
